...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#c31432] to-[#240b36] h-screen flex justify-center">
      <div className="bg-[#252525] w-[20rem]  sm:w-[24rem] h-fit my-auto p-5 rounded-lg">
        ...
        <div className="my-3 font-semibold ">
          <Button className="w-full rounded-xl tracking-wider bg-[#f3263dd4] hover:bg-[#f3263eac] py-[1.5rem] font-semibold">Create a new wallet</Button>
        </div>
        <div className="my-3">
